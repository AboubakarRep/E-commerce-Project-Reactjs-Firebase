...
const CartPage = () => {
    const cartItems = useSelector((state) => state.cart || []); // Assurez-vous que c'est un tableau
                    ...
                    <form className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:gap-x-16">
                        <section aria-labelledby="cart-heading" className="rounded-lg bg-white lg:col-span-8">
                            <h2 id="cart-heading" className="sr-only">
                                Produit dans votre Panier d'Achat
                            </h2>
                                                    ...
                                                    <div className="mb-2 flex">
                                                        ...
                                                        <div className="ml-6 flex text-sm">
                                                            <button onClick={() => deleteCart(item)} type="button" className="flex items-center space-x-1 px-2 py-1 pl-0">
                                                                ...
                                                                <span className="text-xs font-medium text-red-500">Supprimé</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div>
                                <dl className="space-y-1 px-2 py-4">
                                    <div className="flex items-center justify-between">
                                        <dt className="text-sm text-gray-800">Prix ({cartItemTotal} item)</dt>
                                    ...
                                    <div className="flex items-center justify-between py-4">
                                        ...
                                        <dd className="text-sm font-medium text-green-700">Gratuit</dd>
                                    </div>
